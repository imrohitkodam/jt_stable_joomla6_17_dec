...
?>
	...
	if ($onlineEventsEnable == '1')
	{
		...
		{
			?>
			<div class="tj-filterhrizontal float-start col-xs-12 col-sm-3 col-md-2 eventFilter__ht af-mb-5" >
				<div>
					<div>
	...
	<div class="tj-filterhrizontal row" >
		<?php
		// Location
		...
		?><div class="col-xs-12 col-sm-3 col-md-3 af-mb-5">
		<?php
		// Date
