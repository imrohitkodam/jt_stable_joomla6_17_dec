...
(function($) {
	...
	Calendar.prototype.navigate = function(where, next) {
		...
		if(where == 'next') {
		...
		else if(where == 'prev-year') {
			//$('#but-today').show();
			switch(this.options.view) {
				case 'year':
					to.start.setFullYear(this.options.position.start.getFullYear());
					break;
				case 'month':
					to.start.setMonth(this.options.position.start.getMonth() );
					break;
				case 'week':
					to.start.setDate(this.options.position.start.getDate() - 7);
					break;
			...
			this.options.day = (to.start.getFullYear() -1) + '-' + to.start.getMonthFormatted() + '-' + to.start.getDateFormatted();
		}
		else if(where == 'next-year') {
			//$('#but-today').show();
			switch(this.options.view) {
				case 'year':
					to.start.setFullYear(this.options.position.start.getFullYear());
