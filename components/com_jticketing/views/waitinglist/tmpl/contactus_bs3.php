...
<div class="row" id="jtwrap">
	...
	<form name="adminForm" id="adminForm" class="form-validate form-horizontal jtFilters" method="post" enctype="multipart/form-data">
		...
		<div class="control-group">
			<div><?php echo  Text::_('COM_JTICKETING_ENTER_EMAIL_ID') ?> *</div>
			<div>
				<textarea id="selected_emails" name="selected_emails" readonly="true" ><?php echo implode(",", $this->selectedEmails);?></textarea>
			</div>
		</div>

		<div class="control-group">
			<div><?php echo  Text::_('COM_JTICKETING_ENTER_EMAIL_SUBJECT') ?> *</div>
			<div>
				<input type="text" id="jt-message-subject" name="jt-message-subject"  class="span2 required" style="width:233px"
				placeholder="<?php echo  Text::_('COM_JTICKETING_ENTER_EMAIL_SUBJECT') ?>">
			</div>
		</div>

		<div class="control-group">
			<div><?php echo  Text::_('COM_JTICKETING_EMAIL_BODY') ?> *</div>
			<div>
				<?php
