...
?>
	<div class="row event_details_form af-mt-10">
		...
		<div class="col-md-4 col-xs-12">
			...
			?>
			<div class="row mt-2">
				<div class="col-sm-12 col-xs-12 af-mb-10 eventDateTime list-width" id="venue_id">
			...
			?>
				<div class="row">
					<div class="col-sm-12 col-xs-12 af-mb-10 eventDateTime list-width" id="venuechoice_id">
				...
				<div class="row">
					<div class="col-sm-12 col-xs-12 af-mb-10 eventDateTime list-width" id="existingEvent">
			...
			<div class="row mt-2" id="event-location">
