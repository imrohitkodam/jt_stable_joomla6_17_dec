        ...
        <table class="table table-striped">
            <thead>
                ...
                <?php endif; ?>
                    ...
                    <th><?php echo Text::_('COM_JTICKETING_CHECKIN_TIME'); ?></th>
                    <th><?php echo Text::_('COM_JTICKETING_CHECKIN'); ?></th>
                    <th><?php echo Text::_('COM_JTICKETING_ENROLMENT_NOTIFY'); ?></th>
                </tr>
            </thead>
            <tbody>
                        ...
                        <td class="center">
                            <?php if ($event->status == 'A') : ?>
                                <a href="javascript:void(0);"
                                    class="hasTooltip"
                                    data-original-title="<?php echo Text::_('COM_JTICKETING_CHECKIN'); ?>"
                                    onclick="
