...
<?php else : ?>
    ...
    <form action="<?php echo Route::_('index.php?option=com_jticketing&view=recurringevents&attendee_id=' . (int) $this->attendeeId); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                <?php if ($this->tmpl !== 'default') : ?>
                    <th scope="col" width="1%">
                        <input type="checkbox" name="checkall-toggle" value="" title="<?php echo Text::_('JGLOBAL_CHECK_ALL'); ?>" onclick="Joomla.checkAll(this)" />
                    </th>
                <?php endif; ?>
                    <th scope="col"><?php echo Text::_('COM_JTICKETING_SERIAL_NO'); ?></th>
                    <th scope="col"><?php echo Text::_('COM_JTICKETING_DATE'); ?></th>
                    <th scope="col"><?php echo Text::_('COM_JTICKETING_START_TIME'); ?></th>
                    <th scope="col"><?php echo Text::_('COM_JTICKETING_END_TIME'); ?></th>
                    <th scope="col"><?php echo Text::_('COM_JTICKETING_CHECKIN_TIME'); ?></th>
                    <th scope="col"><?php echo Text::_('COM_JTICKETING_CHECKIN'); ?></th>
                    <th scope="col"><?php echo Text::_('COM_JTICKETING_ENROLMENT_NOTIFY'); ?></th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <?php endif; ?>
                        ...
                        <td>
                            ...
                            if (!empty($event->checkintime) && !empty($event->checkin)) {
                                echo htmlspecialchars($event->checkintime);
                            } else {
                                echo '-';
                            }
                            ?>
                        ...
                        <td class="text-center">
                            <?php if ($event->status == 'A') : ?>
                                <a href="javascript:void(0);"
                                    ...
                                    title="<?php echo Text::_('COM_JTICKETING_CHECKIN'); ?>"
                                    onclick="
