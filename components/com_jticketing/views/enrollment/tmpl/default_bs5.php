	...
	<div class="container-fluid">
		...
		<form method="post" name="adminForm" id="adminForm">
			...
			<div class="form-actions">
				<div id="enroll-user" class='col-md-12'>
					<div class='row justify-content-md-end'>
						<div class="col-md-5">
							<div class="row">
								...
								<div class="col-md-4">
									<button class="btn btn-block btn-primary float-end" type="button" name="enrol" id="enrol" onclick="jtCommon.enrollment.saveEnrollment('save')" value="" /><?php echo Text::_('COM_JTICKETING_ENROL_USER_BUTTON'); ?></button>
								</div>
							</div>
						</div>
					</div>
