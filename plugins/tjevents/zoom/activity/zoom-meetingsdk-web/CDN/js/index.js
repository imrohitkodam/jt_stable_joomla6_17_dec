...
function websdkready() {
  ...
  var CLIENT_ID = document.getElementById("sdk_key").value;
  /**
   ...
   */
  var CLIENT_SECRET = document.getElementById("sdk_secret").value;
    ...
    .addEventListener("click", function (e) {
      ...
      testTool.setCookie("meeting_pwd", meetingConfig.pwd);
        ...
        success: function (res) {
          ...
          var joinUrl = "plugins/tjevents/zoom/activity/zoom-meetingsdk-web/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          document.getElementById("zoomframe").style.display = "block";
          const currentURL = window.location.href;
          const origin = new URL(currentURL).origin;
          const targetURL = `${origin}/`;
          const basePath = Joomla.getOptions('system.paths').baseFull ? Joomla.getOptions('system.paths').baseFull : window.location.origin + '/';
          document.getElementById("zoomframe").setAttribute("src", basePath+joinUrl);
          // document.getElementById("zoomframe").setAttribute("src", targetURL+joinUrl);
          // console.log(joinUrl);
        },
      });
    });
