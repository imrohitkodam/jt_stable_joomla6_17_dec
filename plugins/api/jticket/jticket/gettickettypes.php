	...
	public function get()
	{
		...
		if ($tickettypes)
		{
			foreach ($tickettypes as &$tickettype)
			{
				...
				{
					$tickettype->available = Text::_('COM_JTICKETING_UNLIMITED_SEATS');
				}

				$tickettype->soldticket = JT::tickettype($tickettype->id)->getSoldCount();
				...
				$tickettype->checkins = JT::tickettype($tickettype->id)->getCheckinCount();
