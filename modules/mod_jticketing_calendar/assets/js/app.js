...
var root_url = jQuery('#jt_root_url').val();

techjoomla.jQuery.ajax(
{
	url:Joomla.getOptions('system.paths').root+'/index.php?option=com_jticketing&task=calendar.getEventList',
	type:'GET',
	dataType: "json",
	success:function(data)
	{
		...
		"use strict";
			var options = {
						...
						var calendar = $('.jtcalendarForm #jt-calendar-module').calendar(options);
