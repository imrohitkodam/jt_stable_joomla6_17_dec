...
<?php
	...
	<div class="tjBs3 jt-admin-dashboard">
		<div class="tjDB">
			<div class="row">
				<?php echo $this->loadTemplate('version_bs2'); ?>
			</div>
			<div id="wrapper">
				<div id="page-wrapper">
									...
									<div class="panel-heading">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												...
												<div><?php echo Text::_('COM_JTICKETING_DASHBOARD_EVENTS');?></div>
											</div>
										</div>
									</div>
									<div class="panel-footer">
										<span class="pull-left"><?php echo Text::_('COM_JTICKETING_VIEW_DETAILS');?></span>
									...
									<div class="panel-heading">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												...
												<div><?php echo Text::_('COM_JTICKETING_DASHBOARD_TOTAL_ATTENDEE');?></div>
											</div>
										</div>
									</div>
									<div class="panel-footer">
									...
									<div class="panel-heading">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												...
												<div><?php echo Text::_('COM_JTICKETING_DASHBOARD_ORDERS');?></div>
											</div>
										</div>
									</div>
									<div class="panel-footer">
									...
									<div class="panel-heading">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												...
												<div><?php echo Text::_('COM_JTICKETING_DASHBOARD_COMMISSION_AMOUNT');?></div>
											</div>
										</div>
									</div>
									<div class="panel-footer">
									...
									<div class="panel-heading">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												...
												<div><?php echo Text::_('COM_JTICKETING_DASHBOARD_FEATURED_EVENTS');?></div>
											</div>
										</div>
									</div>
									<div class="panel-footer">
									...
									<div class="panel-heading">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												...
												<div><?php echo Text::_('COM_JTICKETING_DASHBOARD_PAST_EVENTS');?></div>
											</div>
										</div>
									</div>
									<div class="panel-footer">
									...
									<div class="panel-heading">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												...
												<div><?php echo Text::_('COM_JTICKETING_DASHBOARD_UPCOMING_EVENTS');?></div>
											</div>
										</div>
									</div>
									<div class="panel-footer">
					...
					<div class="row">
						<div class="col-lg-8">
							...
							<div class="row">
								<div class="col-lg-7">
									<?php echo $this->loadTemplate("periodicgraph_bs2");?>
								</div>
								...
								<div class="panel-body">
									...
									<div class="row">
										<div class = "col-lg-12 col-md-12 col-sm-12">
											<p class = "pull-right"><span class="label label-info"><?php echo Text::_('COM_JTICKETING_LINKS'); ?></span></p>
										</div>
									</div>
