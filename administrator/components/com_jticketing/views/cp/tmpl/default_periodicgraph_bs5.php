		...
		<div class="col-12 col-md-12">
			<div class="row">
				<div class="form-group af-mb-10">
					<label label-default class="col-md-3 col-sm-3 col-xs-12 form-label"><?php echo Text::_('COM_JTICKETING_FROM_DATE');?>
					</label>
					<div class="col-md-9 col-sm-10 col-xs-12">
						<div class="input-group">
							<?php echo HTMLHelper::_('calendar',
								$backdate, 'fromDate', 'from', '%Y-%m-%d',
								array('class' => 'inputbox','readonly' => 'true')
								);?>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="form-group af-mb-10 mt-1">
					<label label-default class="col-md-3 col-sm-3 col-xs-12 form-label"><?php echo Text::_('COM_JTICKETING_TO_DATE');?></label>
					<div class="col-md-9 col-sm-10 col-xs-12">
						<div class="input-group">
							<?php echo HTMLHelper::_('calendar',
			...
			<div class="row">
				<div class="col-12 form-group mt-1">
					<div class="col-xs-12 float-end">
						<div class="">
							<input id="btnRefresh"
								class="btn btn-micro btn-primary float-end"
								type="button"
