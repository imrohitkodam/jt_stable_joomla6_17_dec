...
<form  name="adminForm" id="adminForm" class="form-validate form-horizontal sendEmailtoWaitingListForm" method="post" enctype="multipart/form-data">
		...
		<div class="row-fluid">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<textarea id="selected_emails" name="selected_emails" readonly="true" >
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						class="span2 required  " style="width:233px" placeholder="<?php echo  Text::_('COM_JTICKETING_ENTER_EMAIL_SUBJECT') ?>">
					</div>
				</div>
