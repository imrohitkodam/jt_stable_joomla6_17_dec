					...
					echo HTMLHelper::_('bootstrap.addTab', 'myTab', 'details', Text::_('COM_JTICKETING_EVENT_TAB_DETAILS', true));
						echo HTMLHelper::_('bootstrap.startAccordion', 'myAccordian', array('active' => 'collapse1'));
							...
							echo HTMLHelper::_('bootstrap.addSlide', 'myAccordian', Text::_('COM_JTICKETING_EVENT_TAB_LOCATION'), 'collapse2', $class='');
								echo $this->loadTemplate('location_bs2');
							echo HTMLHelper::_('bootstrap.endSlide');
					...
					<div class="span12 well">
						...
						<div class="control-group">
							...
							<div class="af-ml-15 gallary__validateBtn af-d-inline-block">
								<input type="button" class="validate_video_link" onclick="tjMediaFile.validateFile(this,1, <?php echo $this->isAdmin;?>, 'event')"
					...
					<div class="span12 subform-wrapper">
						  <ul class="gallary__media thumbnails">
							 <li class="gallary__media--li hide span2">
								<a class="close" onclick="tjMediaFile.tjMediaGallery.deleteMedia(this, <?php echo $this->isAdmin;?>, <?php echo (!empty($this->item->id))? $this->item->id : 0;?>, 'event');return false;">×</a>
...
{?>
	<style>
		...
		#tickettypes .subform-repeatable-group .control-group:nth-last-child(2){
		display: none;
		}
...
Factory::getDocument()->addScriptDeclaration("
	...
	var oldEventStartDate = '" . HTMLHelper::date($this->item->startdate,'Y-m-d H:i', true) . "';
	var oldEventEndDate = '" . HTMLHelper::date($this->item->enddate,'Y-m-d H:i', true) . "';
