...
<form action="" method="post" name="adminForm" id="adminForm">
	<div class="techjoomla-bootstrap">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="float-start">
					...
					echo HTMLHelper::_('select.genericlist', $this->status_event, "search_event", 'class="ad-status form-select" onchange="document.adminForm.submit();" name="search_event"',"value", "text", $search_event);
					?>
				</div>
				<div class="float-end">
		...
		if(empty($this->Data))
		{	?>
			<div class="alert alert-info mt-2"><?php echo Text::_('NODATA');?></div>
