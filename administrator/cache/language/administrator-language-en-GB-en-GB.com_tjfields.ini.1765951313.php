...
return array (
  ...
  'COM_TJFIELDS_FILTER_SELECT_FIELD_TYPE_LABEL' => ' - Select Field Type - ',
  ...
  'COM_TJFIELDS_FIELDS_DELETE_CONFIRMATION' => 'All the fields and data related to selected fields will be deleted. Are you sure that you want to delete the selected field(s)?',
  ...
  'COM_TJFIELDS_FORM_LBL_FIELD_RENDERER_DOWNLOAD' => 'Download Link',
  'COM_TJFIELDS_FORM_LBL_FIELD_RENDERER_PREVIEW' => 'Preview Link',
  'COM_TJFIELDS_FORM_LBL_FIELD_RENDERER' => 'Select Renderer',
  'COM_TJFIELDS_FORM_DESC_FIELD_RENDERER' => 'Select renderer for the file field </br></br> <b>NOTE:- Use \'Download Link\' renderer if privacy of the uploaded files is critical as this will not expose the path of the file storage and will provide more security<b>',
  'COM_TJFIELDS_FORM_LBL_FIELD_ACCEPT' => 'Allowed File Type(s)',
  'COM_TJFIELDS_FORM_DESC_FIELD_ACCEPT' => 'Specify comma separated allowed file types / extensions starting with the STOP character, e.g: .gif, .jpg, .png',
  'COM_TJFIELDS_FORM_LBL_FILE_UPLOAD_PATH' => 'File upload path',
  'COM_TJFIELDS_FORM_DESC_FILE_UPLOAD_PATH' => 'Enter the filesystem path where uploaded files are stored. Needs to be an absolute path.',
  'COM_TJFIELDS_FORM_LBL_FILE_FIELD_SIZE' => 'Max allowed upload size (in MB)',
  'COM_TJFIELDS_FORM_LBL_FILE_UPLOAD_PATH_NOTICE' => 'Current path <span id="currentUploadPath"></span><br/>If you change the path, make sure the new path exists and you have copied/moved the files from the old path to the new.',
  'COM_TJFIELDS_FORM_DESC_FILE_FIELD_SIZE' => 'Set maximum allowed upload file size (in MB) e.g 10, 20',
  ...
  'COM_TJFIELDS_GROUPS_DELETE_CONFIRMATION' => 'All the selected field group(s) and the fields in the selected field group(s) along with the data related to the field group(s) and the fields will be deleted. Are you sure that you want to delete the selected field group(s)?',
  ...
  'COM_TJFIELDS_SINGLE_SELECT' => 'Single Select (Deprecated. Use Field Type \'List\')',
  'COM_TJFIELDS_MULTI_SELECT' => 'Multi Select  (Deprecated. Use Field Type \'List\')',
  ...
  'COM_TJFIELDS_COUNTRIES_COUNTRY_TEXT' => 'Country Language Constant',
  ...
  'COM_TJFIELDS_REGIONS_REGION_TEXT' => 'Region Language Constant',
  ...
  'COM_TJFIELDS_FORM_LBL_REGION_REGION_TEXT' => 'Region Language Constant',
  'COM_TJFIELDS_FORM_DESC_REGION_REGION_TEXT' => 'Enter Region Language Constant',
  'COM_TJFIELDS_FORM_DESC_REGION_REGION_TEXT_HELP' => '*You will need to add this constant in the language file you are using. <br/>English language file for region names is located at - YOUR_SITE/language/en-GB/en-GB.tjgeo.regions.ini<br/>e.g. Add this in language file-<br/>TJ_GEO_REGION_NEWYORK="_QQ_"New York"_QQ_"',
  ...
  'COM_TJFIELDS_CITIES_CITY_TEXT' => 'City Language Constant',
  ...
  'COM_TJFIELDS_FORM_LBL_CITY_CITY_TEXT' => 'City Language Constant',
  'COM_TJFIELDS_FORM_DESC_CITY_CITY_TEXT' => 'Enter City Language Constant',
  'COM_TJFIELDS_FORM_DESC_CITY_CITY_TEXT_HELP' => '*You will need to add this constant in the language file you are using. <br/>English language file for city names is located at - YOUR_SITE/language/en-GB/en-GB.tjgeo.city.ini<br/>e.g. Add this in language file-<br/>TJ_GEO_CITY_NEWYORK="_QQ_"New York"_QQ_"',
  ...
  'COM_TJFIELDS_FORM_LBL_NUMBER_FIELD_COMPARE' => 'Compare field value?',
  'COM_TJFIELDS_FORM_DESC_NUMBER_FIELD_COMPARE' => 'Enable to compare field value with other field\'s value',
  'COM_TJFIELDS_FORM_NUMBER_FIELD_COMPARE_WITH_FIELD' => 'Select field to compare with',
  'COM_TJFIELDS_FORM_LBL_FIELD_COMPARE_WITH_FIELD_LOGIC' => 'Compare logic',
  'COM_TJFIELDS_FORM_DESC_FIELD_COMPARE_WITH_FIELD_LOGIC' => 'Select compare logic',
  'COM_TJFIELDS_FORM_FIELD_COMPARE_WITH_FIELD_LOGIC_GREATER' => 'Greater than',
  'COM_TJFIELDS_FORM_FIELD_COMPARE_WITH_FIELD_LOGIC_LESS' => 'Less than',
  'COM_TJFIELDS_FORM_FIELD_COMPARE_WITH_FIELD_LOGIC_GREATER_THAN_OR_EQUAL' => 'Greater than or equal to',
  'COM_TJFIELDS_FORM_FIELD_COMPARE_WITH_FIELD_LOGIC_LESS_THAN_OR_EQUAL' => 'Less than or equal to',
  'COM_TJFIELDS_FORM_LBL_FIELD_COMPARE_WITH_FIELD' => 'Field to compare with',
  'COM_TJFIELDS_FORM_DESC_FIELD_COMPARE_WITH_FIELD' => 'Select field to compare with',
  ...
  'COM_TJFIELDS_FORM_LBL_CALENDAR_FIELD_SHOWTIME' => 'Show Time?',
  'COM_TJFIELDS_FORM_DESC_CALENDAR_FIELD_SHOWTIME' => 'If show time set to true then calender field allows you to add time with date. just need to add time format \'%H:%M:%S\' in date format',
  'COM_TJFIELDS_FORM_LBL_CALENDAR_FIELD_TRANSLATEFORMAT' => 'Translate Format?',
  'COM_TJFIELDS_FORM_DESC_CALENDAR_FIELD_TRANSLATEFORMAT' => 'If set to true, the calendar will use the DATE_FORMAT_CALENDAR_DATE language key (if showtime is true) or DATE_FORMAT_CALENDAR_DATETIME (if showtime is false) to determine the format. The format attribute is ignored. If false, the format attribute is used but note that the format string must include time fields for the time to be recorded. Defaults to false.',
  'COM_TJFIELDS_FORM_LBL_CALENDAR_FIELD_WEEKNUMBERS' => 'Show week number?',
  'COM_TJFIELDS_FORM_DESC_CALENDAR_FIELD_WEEKNUMBERS' => 'If set to yes, a column is added at the left of the date picker to display the number of the week in the current year',
  'COM_TJFIELDS_IMAGE' => 'Image',
  'COM_TJFIELDS_FORM_LBL_IMAGE_HEIGHT' => 'Height',
  'COM_TJFIELDS_FORM_LBL_FIELD_WIDTH' => 'Width',
  'COM_TJFIELDS_FORM_DESC_IMAGE_FIELD_HEIGHT' => 'Display Image Height',
  'COM_TJFIELDS_FORM_DESC_IMAGE_FIELD_WIDTH' => 'Display Image Width',
  'COM_TJFIELDS_FORM_DESC_FIELD_AUTOPLAY_AUDIO_LINK' => 'Enable to auto play audio on page load',
  'COM_TJFIELDS_AUDIO' => 'Audio',
  'COM_TJFIELDS_FORM_LBL_FIELD_MUTED_AUDIO' => 'Muted',
  'COM_TJFIELDS_FORM_DESC_FIELD__MUTED_AUDIO' => 'Enable to keep audio muted on page load',
  'COM_TJFIELDS_FORM_DESC_AUDIO_FIELD_HEIGHT' => 'Audio player height in pixels',
  'COM_TJFIELDS_FORM_DESC_AUDIO_FIELD_WIDTH' => 'Audio player width in pixels',
  'COM_TJFIELDS_VIDEO' => 'Video',
  'COM_TJFIELDS_FORM_DESC_VIDEO_FIELD_HEIGHT' => 'Video display height',
  'COM_TJFIELDS_FORM_DESC_VIDEO_FIELD_WIDTH' => 'Video display width',
  'COM_TJFIELDS_FORM_LBL_FIELD_SHOW_VIDEO_LINK' => 'Show video link',
  'COM_TJFIELDS_FORM_DESC_FIELD_SHOW_VIDEO_LINK' => 'Show video link',
  'COM_TJFIELDS_FORM_LBL_FIELD_EXAMPLE_POSTER_LINKS' => 'poster link',
  'COM_TJFIELDS_FORM_LBL_FIELD_POSTER' => 'Poster',
  'COM_TJFIELDS_FORM_DESC_FIELD_POSTER' => 'Video Poster',
  'COM_TJFIELDS_FORM_LBL_FIELD_AUTOPLAY_VIDEO_LINK' => 'AutoPlay',
  'COM_TJFIELDS_FORM_DESC_FIELD_AUTOPLAY_VIDEO_LINK' => 'Enable to auto play video on page load',
  'COM_TJFIELDS_FORM_LBL_FIELD_VIMEO_VIDEO' => 'Vimeo',
  'COM_TJFIELDS_FORM_DESC_FIELD_VIMEO_VIDEO' => 'Allow Vimeo videos',
  'COM_TJFIELDS_FORM_LBL_FIELD_FACEBOOK_VIDEO' => 'Facebook',
  'COM_TJFIELDS_FORM_DESC_FIELD_FACEBOOK_VIDEO' => 'Allow Facebook videos',
  'COM_TJFIELDS_FORM_LBL_FIELD_TWITCH_VIDEO' => 'Twitch',
  'COM_TJFIELDS_FORM_DESC_FIELD_TWITCH_VIDEO' => 'Allow Twitch videos',
  'COM_TJFIELDS_FORM_LBL_FIELD_DAILYMOTION_VIDEO' => 'DailyMotion',
  'COM_TJFIELDS_FORM_DESC_FIELD_DAILYMOTION_VIDEO' => 'Allow DailyMotion videos',
  'COM_TJFIELDS_FORM_LBL_FIELD_SOUNDCLOUD_VIDEO' => 'Soundcloud',
  'COM_TJFIELDS_FORM_DESC_FIELD_SOUNDCLOUD_VIDEO' => 'Allow Soundcloud videos',
  'COM_TJFIELDS_FORM_LBL_FIELD_DISPLAY_VIDEO' => 'Display Style',
  'COM_TJFIELDS_FORM_DESC_FIELD_DISPLAY_VIDEO' => 'Select video display style',
  'COM_TJFIELDS_POPUP' => 'Popup',
  'COM_TJFIELDS_NORMAL' => 'Normal',
  'COM_TJFIELDS_ITEM_CATEGORY' => 'Item Category',
  'COM_TJFIELDS_OWNERSHIP' => 'Ownership',
  'COM_TJFIELDS_FORM_LBL_FIELD_OWNERSHIP_MAKE_USER_ITEM_OWNER' => 'Set as UCM Type Item Creator?',
  'COM_TJFIELDS_FORM_DESC_FIELD_OWNERSHIP_MAKE_USER_ITEM_OWNER' => 'If enabled then the selected user will be set as creator of the UCM type item',
  'COM_TJFIELDS_CLUSTER' => 'Cluster',
  'COM_TJFIELDS_RELATED' => 'Related',
  'COM_TJFIELDS_RELATED_UCM_TYPE' => 'UCM Type',
  'COM_TJFIELDS_RELATED_FIELDS' => 'Fields',
  'COM_TJFIELDS_RELATED_SELECT_UCM_TYPE' => 'Select UCM type <br><br> <b>NOTE:- You can select one UCM type only once</b>',
  'COM_TJFIELDS_RELATED_SELECT_UCM_TYPE_OPTION' => 'Select UCM type',
  'COM_TJFIELDS_RELATED_SELECT_FIELDS' => 'Select fields of clients for which the value is to be loaded',
  'COM_TJFIELDS_FORM_LBL_FIELD_RELATED_MULTIPLE' => 'Multiple',
  'COM_TJFIELDS_FORM_DESC_FIELD_RELATED_MULTIPLE' => 'Enable multiple option selection',
  'COM_TJFIELDS_FORM_LBL_FIELD_RELATED_ADD_RECORD_LINK' => 'Show \'Add Record\' Link',
  'COM_TJFIELDS_FORM_DESC_FIELD_RELATED_ADD_RECORD_LINK' => 'Enabling this will show a link to add record in the selected UCM type (Link will only be shown if the logged in user has the permission to add a record)',
  'COM_TJFIELDS_FORM_LBL_FIELD_RELATED_SELECT_UCM_TYPE' => 'Data Source',
  'COM_TJFIELDS_FORM_DESC_FIELD_RELATED_SELECT_UCM_TYPE' => 'Select UCM type and related fields from which the options list should be loaded',
  'COM_TJFIELDS_FORM_DESC_FIELD_RELATED_ADD_RECORD' => 'Add Record',
  'COM_TJFIELDS_FORM_LBL_FIELD_RELATED_CLUSTER_AWARE' => 'Cluster Aware?',
  'COM_TJFIELDS_FORM_DESC_FIELD_RELATED_CLUSTER_AWARE' => 'Enable to make field cluster aware',
  'COM_TJFIELDS_FORM_LBL_FIELD_RELATED_CLUSTER_FIELD' => 'Cluster Field',
  'COM_TJFIELDS_FORM_DESC_FIELD_RELATED_CLUSTER_FIELD' => 'Select related cluster field',
  'COM_TJFIELDS_FORM_LBL_FIELD_SELECT_RELATED_CLUSTER_FIELD' => '- Select Cluster Field -',
  'COM_TJFIELDS_FORM_LBL_FIELD_RELATED_SHOW_PARENT_RECORDS_ONLY' => 'Show Data of Parent UCM',
  'COM_TJFIELDS_FORM_DESC_FIELD_RELATED_SHOW_PARENT_RECORDS_ONLY' => 'If this is enabled then the field will show records of parent UCM record only',
  'COM_TJFIELDS_TJLIST' => 'List',
  'COM_TJFIELDS_TJLIST_OTHER_OPTION' => 'Other',
  'COM_TJFIELDS_TJLIST_OTHER_OPTION_VALUE' => 'tjlistothervalue',
  'COM_TJFIELDS_FORM_LBL_FIELD_TJLIST_MULTIPLE' => 'Multiple',
  'COM_TJFIELDS_FORM_DESC_FIELD_TJLIST_MULTIPLE' => 'Enable multiple option selection',
  'COM_TJFIELDS_FORM_LBL_FIELD_TJLIST_OTHER' => 'Allow Other Option',
  'COM_TJFIELDS_FORM_DESC_FIELD_TJLIST_OTHER' => 'It will prepopulate \'Other\' option in the dropdown. A Textbox will be shown if \'Other\' option is selected',
  'COM_TJFIELDS_OTHER_VALUE' => 'Other',
  'COM_TJFIELDS_FIX_DATABASE' => 'Fix Database',
  'COM_TJFIELDS_PERMISSION_VIEW_OWN_FIELD_VALUE' => 'View Own Field Value',
  'COM_TJFIELDS_PERMISSION_VIEW_OWN_FIELD_VALUE_DESC' => 'Users in the group to view own field data.',
  ...
  'COM_TJFIELDS_FORM_LBL_ITEM_CATEGORY_FIELD_STATE' => 'State',
