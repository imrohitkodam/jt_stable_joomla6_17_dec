...
return array (
  ...
  'COM_TJNOTIFICATIONS_FIELD_CLIENT_LABEL' => 'Client',
  ...
  'COM_TJNOTIFICATIONS_FIELD_TITLE_OPTION' => 'Choose Title',
  ...
  'COM_TJNOTIFICATIONS_FIELD_PUSH_STATUS_LABEL' => 'Push Status',
  'COM_TJNOTIFICATIONS_FIELD_PUSH_SUBJECT_LABEL' => 'Subject',
  'COM_TJNOTIFICATIONS_FIELD_PUSH_BODY_LABEL' => 'Push Body',
  'COM_TJNOTIFICATIONS_FIELD_WEB_STATUS_LABEL' => 'Web Status',
  ...
  'COM_TJNOTIFICATIONS_FIELD_EMAIL_SUBJECT_DESC' => 'Enter subject for your Email notification',
  'COM_TJNOTIFICATIONS_FIELD_SMS_SUBJECT_DESC' => 'Enter subject for your SMS notification',
  'COM_TJNOTIFICATIONS_FIELD_PUSH_SUBJECT_DESC' => 'Enter subject for your Push notification',
  'COM_TJNOTIFICATIONS_FIELD_WEB_SUBJECT_DESC' => 'Enter subject for your Web notification',
  'COM_TJNOTIFICATIONS_FIELD_EMAIL_BODY_DESC' => 'Enter body for your Email notification',
  'COM_TJNOTIFICATIONS_FIELD_SMS_BODY_DESC' => 'Enter body for your SMS notification',
  'COM_TJNOTIFICATIONS_FIELD_PUSH_BODY_DESC' => 'Enter body for your Push notification',
  'COM_TJNOTIFICATIONS_FIELD_WEB_BODY_DESC' => 'Enter body for your Web notification',
  'COM_TJNOTIFICATIONS_VIEW_NOTIFICATIONS_PUBLISH' => 'Publish',
  ...
  'COM_TJNOTIFICATIONS_STATE_DISABLE' => 'Disable',
  'COM_TJNOTIFICATIONS_STATE_ENABLE_SUCCESS_MSG' => 'Enable successfully.',
  'COM_TJNOTIFICATIONS_STATE_DISABLE_MSG' => 'Disable successfully.',
  'COM_TJNOTIFICATIONS_STATE_DISABLE_FAIL_MSG' => 'Cannot enable email status, please fill email body and subject.',
  ...
  'COM_TJNOTIFICATIONS_NOTIFICATION_LANGUAGE_DESC' => 'Choose language',
  'COM_TJNOTIFICATIONS_TEMPLATE_ERR_MSG_TEMPLATE_EXISTS' => 'Template you are creating for this component and language is already created, please create for another Language',
  'COM_TJNOTIFICATIONS_EMAIL_FIELDS_DESC' => 'Email Fields Description',
  'COM_TJNOTIFICATIONS_EMAIL_FIELDS' => 'Email Fields',
  'COM_TJNOTIFICATIONS_FIELD_EMAIL_CC_LABEL' => 'CC',
  'COM_TJNOTIFICATIONS_FIELD_EMAIL_CC_DESC' => 'Enter CC for notification',
  'COM_TJNOTIFICATIONS_FIELD_EMAIL_BCC_LABEL' => 'BCC',
  'COM_TJNOTIFICATIONS_FIELD_EMAIL_BCC_DESC' => 'Enter BCC for notification',
  'COM_TJNOTIFICATIONS_FIELD_EMAIL_FROM_NAME_LABEL' => 'From Name',
  'COM_TJNOTIFICATIONS_FIELD_EMAIL_FROM_NAME_DESC' => 'Enter from name for notification',
  'COM_TJNOTIFICATIONS_FIELD_EMAIL_FROM_EMAIL_LABEL' => 'From Email',
  'COM_TJNOTIFICATIONS_FIELD_EMAIL_FROM_EMAIL_DESC' => 'Enter From email for notification',
  'COM_TJNOTIFICATIONS_SMS_FIELDS_DESC' => 'SMS Fields Description',
  'COM_TJNOTIFICATIONS_SMS_FIELDS' => 'SMS Fields',
  'COM_TJNOTIFICATIONS_VIEW_NOTIFICATIONS_DEFAULT_PUSH_TITLE' => 'Push',
  'COM_TJNOTIFICATIONS_PUSH_FIELDS' => 'Push Notification Fields',
  'COM_TJNOTIFICATIONS_PUSH_FIELDS_DESC' => 'Set push notification fields',
  'COM_TJNOTIFICATIONS_VIEW_NOTIFICATIONS_DEFAULT_WHATSAPP_TITLE' => 'Whatsapp',
  'COM_TJNOTIFICATIONS_VIEW_NOTIFICATION_TAB_WHATSAPP' => 'Whatsapp',
  'COM_TJNOTIFICATIONS_WHATSAPP_FIELDS' => 'Whatsapp Fields',
  'COM_TJNOTIFICATIONS_WHATSAPP_FIELDS_DESC' => 'Set Whatsapp Fields',
  'COM_TJNOTIFICATIONS_FIELD_WHATSAPP_BODY_LABEL' => 'Whatsapp Message Body',
  'COM_TJNOTIFICATIONS_FIELD_WHATSAPP_BODY_DESC' => 'Enter body for your Whatsapp notification',
  'COM_TJNOTIFICATIONS_FIELD_WHATSAPP_STATUS_LABEL' => 'Whatsapp Status',
  'COM_TJNOTIFICATIONS_FIELD_WHATSAPP_STATUS_DESC' => 'Turn on this after filling the body to send an Whatsapp notification',
  'COM_TJNOTIFICATIONS_VIEW_NOTIFICATIONS_TRANSLATED_IN' => 'Translated In',
  'COM_TJNOTIFICATIONS_VIEW_NOTIFICATIONS_TRANSLATED_NOT_IN' => 'Not Translated In',
  'COM_TJNOTIFICATIONS_VIEW_NOTIFICATIONS_DEFAULT_EMAIL_TITLE' => 'Email',
  'COM_TJNOTIFICATIONS_VIEW_NOTIFICATIONS_DEFAULT_SMS_TITLE' => 'SMS',
  'JACTION_EMAIL_STATUS' => 'Email Status',
  'JACTION_EMAIL_STATUS_DESC' => 'Allow users in the group to enable or disable the contents in this extension',
  'JACTION_EXPORT' => 'Export',
  'JACTION_EXPORT_COMPONENT_DESC' => 'Allow user to export notifications logs data',
  'JACTION_USER_CONTROL' => 'User Control',
  'JACTION_USER_CONTROL_DESC' => 'Allow users in the group to enable or disable the contents in this extension',
  'JACTION_VIEW' => 'View',
  'JACTION_VIEW_COMPONENT_DESC' => 'Allow user to view notifications logs',
  'JACTION_VIEW_LIST' => 'View List',
  'JACTION_VIEW_LIST_DESC' => 'Allow users in the group to view the contents in this extension',
  ...
  'COM_TJNOTIFICATIONS_FIELD_STATE_OPTION' => 'Choose State',
  'COM_TJNOTIFICATIONS_FIELD_BACKEND_OPTION' => 'Choose Backend',
  ...
  'COM_TJNOTIFICATIONS_SETTINGS_CHOOSE_PUSH_PROVIDER_DESC' => 'Choose Push service provider plugin to be used',
  'COM_TJNOTIFICATIONS_SETTINGS_CHOOSE_SMS_PLUGIN' => 'Choose SMS provider plugin',
  ...
  'COM_TJNOTIFICATIONS_ERROR_MESSAGE_NOT_AUTHORISED' => 'You are not authorised to access this view',
  'COM_TJNOTIFICATIONS_ITEM_SAVED_SUCCESSFULLY' => 'Record saved successfully',
  'COM_TJNOTIFICATIONS_ITEM_DELETED_SUCCESSFULLY' => 'Record deleted successfully',
  'COM_TJNOTIFICATIONS_ITEM_DOESNT_EXIST' => 'Record does not exist!',
  'COM_TJNOTIFICATIONS_SUBSCRIPTION_PAGE_TITLE' => 'Subscription form',
  'COM_TJNOTIFICATIONS_ADD_SUBSCRIPTION_TITLE' => 'Add Subscription',
  'COM_TJNOTIFICATIONS_EDIT_SUBSCRIPTION_TITLE' => 'Edit Subscription',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_ADDRESS_LBL' => 'Address (email / mobile no. / notification token)',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_ADDRESS_DESC' => 'Enter address, it can be email / mobile no. / notification token',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_BACKEND_LBL' => 'Choose Backend',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_BACKEND_DESC' => 'Choose backend to be used',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_DEVICE_ID_LBL' => 'Device ID',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_DEVICE_ID_DESC' => 'Enter device ID',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_IS_CONFIRMED_LBL' => 'Is Confirmed?',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_IS_CONFIRMED_DESC' => 'Is subscription confirmed by user?',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_PLATFORM_LBL' => 'Choose platform',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_PLATFORM_DESC' => 'Choose platform to be used if needed',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_USER_LBL' => 'Choose User',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_USER_DESC' => 'Choose user to be add as a subscriber',
  'COM_TJNOTIFICATIONS_FORM_SUBSCRIPTION_TITLE_LBL' => 'Title',
  ...
  'COM_TJNOTIFICATIONS_PLATFORM_IOS' => 'iOS',
  'COM_TJNOTIFICATIONS_PLATFORM_WEB' => 'Web',
  'COM_TJNOTIFICATIONS_SEARCH_FILTER_SUBMIT' => 'Search',
  'COM_TJNOTIFICATIONS_FILTER_SEARCH_DESC' => 'Search',
  'COM_TJNOTIFICATIONS_FILTER_STATE' => 'Status',
  ...
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_PAGE_TITLE' => 'Subscriptions',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_ADDRESS' => 'Address (email / mobile no. / notification token)',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_BACKEND' => 'Backend',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_DEVICE_ID' => 'Device ID',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_ID' => 'ID',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_IS_CONFIRMED' => 'Is Confirmed',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_PLATFORM' => 'Platform',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_TITLE' => 'Title',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_USER' => 'User',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_ORDER_ID_ASC' => 'ID Ascending',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_ORDER_ID_DESC' => 'ID Descending',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_ORDER_TITLE_ASC' => 'Title Ascending',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_ORDER_TITLE_DESC' => 'Title Descending',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_ORDER_ORDERING_ASC' => 'Order Ascending',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_ORDER_ORDERING_DESC' => 'Order Descending',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_ORDER_STATE_ASC' => 'State Ascending',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_ORDER_STATE_DESC' => 'State Descending',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_PHONE_NUMBER' => 'Select Option',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_PHONE_NUMBER_DESC' => 'Select Option',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_PHONE_NUMBER_JOOMLA' => 'Joomla',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_PHONE_NUMBER_EASYSOCIAL' => 'EasySocial',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_PHONE_NUMBER_JOOMSOCIAL' => 'JoomSocial',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_SELECT_PHONE_NUMBER_FIELD' => 'Select phone number field',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_SELECT_PHONE_NUMBER_FIELD_DESC' => 'Select Phone number field to get phone number',
  'COM_TJNOTIFICATIONS_SUBSCRIPTIONS_SELECT_FIELD' => '-Select-',
  'COM_TJNOTIFICATIONS_SETTINGS_URL_SHORTING' => 'Enable URL shorting?',
  'COM_TJNOTIFICATIONS_SETTINGS_URL_SHORTING_DESC' => 'If set yes, URL from notification will short',
  'COM_TJNOTIFICATIONS_SETTINGS_CHOOSE_URL_SHORTENING_PLUGIN' => 'Choose URL shortening provider',
  'COM_TJNOTIFICATIONS_SETTINGS_CHOOSE_URL_SHORTENING_PLUGIN_DESC' => 'Choose URL shortening provider',
  'COM_TJNOTIFICATIONS_SETTINGS_CHOOSE_BACKEND_SHORTENING' => 'Choose backends for shortening URL',
  'COM_TJNOTIFICATIONS_SETTINGS_CHOOSE_BACKEND_SHORTENING_DESC' => 'Choose backends (like Email, SMS, WhatsApp, Push etc.) for shortening URL',
